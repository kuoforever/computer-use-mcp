...
| Local offline preflight | pending | v2 report SHA-256, identical starting/final commit, both clean checks, constrained child environment, all fixed gates passed |
