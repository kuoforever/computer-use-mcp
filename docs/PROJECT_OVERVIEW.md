...
| `state_dir/campaigns/<campaign_id>/...` | Manifest, heartbeat, item/batch ledgers, handoff | Durable campaign truth; the generic application worker consumes it, while most application-specific discovery adapters remain absent |
