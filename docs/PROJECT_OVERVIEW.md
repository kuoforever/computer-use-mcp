...
| BOSS identity discovery | Implemented/internal preparation | Bounded complete UIA link values produce idempotent stable public job keys with URL query data discarded; no MCP connection, CLI, worker, or application evidence | [Long-running tasks](LONG_RUNNING_TASKS.md) |
