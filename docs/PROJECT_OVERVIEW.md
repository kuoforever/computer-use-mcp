...
| Presence and progress UI | Partial | Passive progress is implemented; a bounded primary-display presence model/controller/Win32 halo is implemented and [desktop verified](PRESENCE_WINDOW_EVIDENCE.md) but not automatically wired into the Agent lifecycle; Decision Cards remain planned | [Operator experience](OPERATOR_EXPERIENCE.md), [Progress viewer](PROGRESS_VIEWER.md) |
