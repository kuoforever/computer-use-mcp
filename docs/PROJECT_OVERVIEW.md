...
| Decision Cards | Partial / fake-only | Pure digest-bound cards compile 2-3 fixed options with evidence, provenance-bearing trade-offs, safe exits, advisory recommendation, expiry, and drift invalidation. No graphical card or ApprovalPort connection exists | [Operator experience](OPERATOR_EXPERIENCE.md) |
