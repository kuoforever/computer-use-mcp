...
1. pass the bounded observation-only Planner/Executor CLI path through retained
   harmless Claude E3 evidence, matching the retained OpenAI result;
...
3. complete the dual-provider E3 gate without broadening the retained OpenAI
   and pending Claude test boundaries;
