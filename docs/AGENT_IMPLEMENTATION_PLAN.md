...
3. address model-specific compatibility gaps, including Sonnet 5 `thinking`
   blocks, only through separately reviewed adapter changes without broadening
   the retained E3 claim;
