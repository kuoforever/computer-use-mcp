...
for the ordinary `run`/`resume` lifecycle and latches off on MCP E-stop, human
activity, terminal state, or cleanup. The
...
remain window-free. Fake-only, digest-bound Decision Card models and
