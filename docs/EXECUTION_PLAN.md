...
| P6 — package and documentation hygiene | Partially complete | Public runtime/package metadata is reconciled at 0.1.0 and an offline release preflight emits sanitized evidence while rejecting start/end candidate drift; licensing/release policy remains open. |
