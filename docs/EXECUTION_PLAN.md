...
| P6 — package and documentation hygiene | Partially complete | Public runtime/package metadata is reconciled at 0.1.0 and an offline release preflight uses a constrained child environment, emits sanitized evidence, and rejects start/end candidate drift; licensing/release policy remains open. |
