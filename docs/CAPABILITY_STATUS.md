...
1. **Hierarchical control and verified learning:** H1-H6 and L0 now fix the node,
   ...
   freshness/window-bound facts, and the exact pinned BOSS observation
   template. L1 quarantine extraction is exact next. None of these early phases
   adds side-effect authority or automatic learning.
