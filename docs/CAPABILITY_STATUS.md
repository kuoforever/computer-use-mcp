...
`doubao-seed-2-0-lite-260215` plus Qwen `qwen3.7-plus` Beijing portions of the
...
fixture proves only one bounded synthetic-image cycle. These records do not
