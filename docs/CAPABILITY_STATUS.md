...
> **Status: current review dashboard, verified 2026-08-11.** This page is the
...
`doubao-seed-2-0-lite-260215` China portions of the
`PARTIAL` cells above. It remains model/route-scoped and records the historical
...
one bounded synthetic-image cycle. These records do not
