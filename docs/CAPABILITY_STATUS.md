...
1. **Hierarchical control and verified learning:** H1-H6 and L0-L3 now fix the node,
   ...
   contracts plus H7's separately gated bounded side-effect sequence. H8 is exact next after L4. None of these phases
