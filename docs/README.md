...
| I need the selected independent product-demo story and its offline-only first contract slice | [Formal Demo v1](FORMAL_DEMO_V1.md) |
...
| Formal Demo v1 | Selected independent GitHub/PDF/Excel/Word/email-draft product story, implemented internal offline v1 contracts, planned Host front door, staged delivery, and formal evidence boundary; not an executable product or application evidence |
