...
| Operator experience | Implemented passive progress, opt-in durable ordinary-run presence, and an opt-in focus-taking two-choice Win32 Decision Card through the existing ApprovalPort; richer choices, broader runtime wiring, and host-owned mobile notification remain planned |
