...
| Persisted continuation | Private v1 storage, opt-in runtime write-ahead boundaries, conservative classification, and a locked one-step CLI gate including completed-side-effect mandatory observation |
