...
| `GDA-PRODUCT-004` | Exact next after merge | Model-driven public-browser-to-disposable-Word product workflow | Installed product entry, non-prewritten brief, durable document verification, exact cleanup, and retained current-main evidence |
