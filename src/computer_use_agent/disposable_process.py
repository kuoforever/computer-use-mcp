...
class Win32ProcessWindows:
    ...
    def snapshot(self, pid: int) -> ProcessWindowSnapshot:
        ...
        return ProcessWindowSnapshot(
            ...
            unowned_window_ids=tuple(
                str(hwnd) for hwnd, owned in windows if not owned
            ),
        )
...
def cleanup_disposable_processes(
    ...
    *,
    ...
    """Close exact windows and preserve unresolved dialog choices for handoff."""
            ...
            if exit_code is not None:
                ...
                if initial.visible_count:
                    ...
                    if stable_zero_count >= stable_zero_observations:
                        ...
                        # Absence observed only at the deadline is not stable
                        # enough to claim cleanup or justify termination.
                        disposition = "handoff_required"
                    else:
                        process.terminate()
